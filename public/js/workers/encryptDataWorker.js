...
"use strict";
/*!***************************************************!*\
  !*** ./resources/js/workers/encryptDataWorker.js ***!
  \***************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/regenerator */ "./node_modules/@babel/runtime/regenerator/index.js");
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__);
...
function _fetchData() {
  _fetchData = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee2(x_csrf) {
    var data,
        response,
        _args2 = arguments;
...
self.addEventListener('message', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee(e) {
    var dataFetch, assembly, localStorage, data, countDecryptedItemsData, percentDecryptedItemsData, countPointsInPart;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return fetchData(e.data.x_csrf);
          ...
          case 5:
            ...
            data = [];
            countDecryptedItemsData = 0;
            percentDecryptedItemsData = 0;
            countPointsInPart = 500;
            dataFetch.forEach(function (item) {
              _config__WEBPACK_IMPORTED_MODULE_1__.propertiesInSeparateTables.forEach(function (property) {
                localStorage[property] = localStorage.hasOwnProperty(property) ? localStorage[property] : [];
                var changed = false;
                var value = item[property];

                if (value) {
                  value = assembly.encrypt(value);
                  var index = localStorage[property].indexOf(value);
              ...
              var date = item['ORDERDATE'].split(' ')[0].split('/').map(function (elem) {
                return parseInt(elem) < 10 ? '0' + elem : elem;
              });
              ...
              var currentPercent = Math.floor(100 / dataFetch.length * countDecryptedItemsData);
